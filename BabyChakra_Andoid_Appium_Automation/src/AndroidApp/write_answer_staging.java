...
public class write_answer_staging
{
	...
	Thread.sleep(5000);		 
	  ...
	  //Verifying login success - feed load
          ...
          // 	driver.findElement(By.id("com.android.packageinstaller:id/permission_allow_button")).click();
            ...
            TouchAction tc6= new TouchAction(driver);
            tc6.tap(288,505).perform();
 
         //Clicking on answer and entering answer..
            try
            
            {
                System.out.println("Test 6: Search for Question");
            ...
            try {
              	 ...
              	 System.out.println("Test 7: Click on Interest");
      			driver.manage().timeouts().implicitlyWait(200, TimeUnit.SECONDS);
      			 TouchAction tc7= new TouchAction(driver);
      	            //driver.manage().timeouts().implicitlyWait(200, TimeUnit.SECONDS);   
       			tc7.tap(driver.findElement(By.id("app.babychakra.babychakra.staging:id/icon"))).perform();
       			driver.manage().timeouts().implicitlyWait(200, TimeUnit.SECONDS);
               }
               catch(Exception e)
                 {
            ...
            try {
           	 ...
           	 System.out.println("Test 8: Click on answer");
   			driver.manage().timeouts().implicitlyWait(200, TimeUnit.SECONDS);
    			...
    			tc8.tap(driver.findElement(By.name("Write answer here..."))).perform();
    			driver.manage().timeouts().implicitlyWait(200, TimeUnit.SECONDS);
            }
            catch(Exception e)
              {
            ...
            {
            	 Thread.sleep(1000);
            	System.out.println("Test 10: Write a answer");
            	TouchAction tc9= new TouchAction(driver);
   	            //driver.manage().timeouts().implicitlyWait(200, TimeUnit.SECONDS);   
    			tc9.tap(driver.findElement(By.id("app.babychakra.babychakra.staging:id/ll_post"))).perform();
            	...
            	TouchAction tc10= new TouchAction(driver);
   	            //driver.manage().timeouts().implicitlyWait(200, TimeUnit.SECONDS);   
    			tc10.tap(driver.findElement(By.id("app.babychakra.babychakra.staging:id/btn_send"))).perform();
    			...
    			TouchAction tc11= new TouchAction(driver);
   	            //driver.manage().timeouts().implicitlyWait(200, TimeUnit.SECONDS);   
    			tc11.tap(driver.findElement(By.id("app.babychakra.babychakra.staging:id/ivMenu_home"))).perform();
